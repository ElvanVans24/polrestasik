<template>
  <div class="container my-5">
    <h1 class="text-center mb-5 prestasi_title">GALERY POLRES TASIKMALAYA KOTA</h1>
    <div class="row row-cols-1 row-cols-md-3 g-4 prestasi_cards">
      <div class="col">
        <div class="card">
      ...
      <div class="col">
        <div class="card">
          <img src="/img/galery12.jpeg" class="card-img-top" alt="Prestasi">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <img src="/img/galery17.jpeg" class="card-img-top" alt="Safety Riding">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <img src="/img/galery18.jpeg" class="card-img-top" alt="Prestasi">
          <div class="card-body">
            <h5 class="card-title">Prestasi Lainnya</h5>
            <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
          </div>
      ...
      <div class="col">
        <div class="card">
          <img src="/img/galery19.jpeg" class="card-img-top" alt="Safety Riding">
          <div class="card-body">
            <h5 class="card-title">Pengujian Lintasan Safety Riding SMKN4 Tasikmalaya</h5>
            <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
          </div>
      ...
      <!-- Add more cards as needed, truncated for brevity -->
    </div>
  </div>
</template>
